function LinkedDistilleries() {
  return (
    <div className="max-w-7xl mx-auto">
      <h1 className="text-4xl font-bold text-accent-gold mb-6">Manage Linked Distilleries</h1>

      {/* Active Distillery */}
      <div className="bg-primary-light rounded-lg border border-accent-blue p-6 mb-6">
        <div className="flex items-center mb-4">
          <label className="text-sm font-medium text-gray-300 mr-4">Active Distillery</label>
          <span className="text-white"></span>
        </div>

        <p className="text-gray-300 mb-6">
          Below are distilleries linked to your active distillery. You may click on a distillery name to manage the internal spirit type and raw material mapping to the linked distillery.
        </p>
