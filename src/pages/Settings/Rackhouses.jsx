function Rackhouses() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <h1 className="text-4xl font-bold text-accent-gold mb-6">Manage Rackhouses</h1>

      {/* Context Labels */}
      <div className="bg-primary-light rounded-lg border border-accent-blue p-4 mb-6">
        <div className="flex items-center space-x-6">
          <div>
            <label className="text-sm font-medium text-gray-300 mr-2">Default Zone</label>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-300 mr-2">Rackhouse:</label>
            <span className="text-white">Default</span>
            <label className="text-sm font-medium text-gray-300 ml-4 mr-2">Zone:</label>
            <span className="text-white">Default</span>
          </div>
        </div>
      </div>

      {/* Add Rackhouse Button */}
      <div className="mb-6">
